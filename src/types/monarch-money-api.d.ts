declare module 'monarch-money-api' {
  ...
  export function getAccounts(): Promise<GetAccountsResponse>;

  export function getAccountTypeOptions(): Promise<GetAccountTypeOptionsResponse>;

  export function getRecentAccountBalances(startDate?: string | null): Promise<GetRecentAccountBalancesResponse>;

  export function getAccountHoldings(accountId: string): Promise<GetAccountHoldingsResponse>;

  export function getAccountHistory(accountId: string): Promise<GetAccountHistoryResponse>;

  export function getSubscriptionDetails(): Promise<GetSubscriptionDetailsResponse>;

  export function getInstitutions(): Promise<GetInstitutionsResponse>;

  export function getAccountSnapshotsByType(startDate: string, timeframe: 'year' | 'month'): Promise<GetSnapshotsByAccountTypeResponse>;

  export function getAggregateSnapshots(
    startDate?: string | null,
    endDate?: string | null,
    accountType?: string | null
  ): Promise<GetAggregateSnapshotsResponse>;

  export function getBudgetSettings(): Promise<GetBudgetSettingsResponse>;
  ...
  export function getTransactions(options?: GetTransactionsOptions): Promise<GetTransactionsResponse>;

  export function getTransactionsSummary(): Promise<GetTransactionsSummaryResponse>;
  ...
  export function getCategoryGroups(): Promise<GetCategoryGroupsResponse>;
  ...
  export function getTransactionTags(options?: GetTransactionTagsOptions): Promise<GetTransactionTagsResponse>;
  ...
  export function getTransactionSplits(transactionId: string): Promise<GetTransactionSplitsResponse>;
  ...
  export function getCashflow(options?: GetCashflowOptions): Promise<GetCashflowResponse>;

  export function getCashflowSummary(options?: GetCashflowOptions): Promise<GetCashflowSummaryResponse>;

  export function getCashFlowDashboard(): Promise<GetCashFlowDashboardResponse>;

  export function deleteTransactionCategory(categoryId: string): Promise<boolean>;

  export function deleteTransactionCategories(categoryIds: string[]): Promise<Array<boolean | Error>>;
  ...
  export function deleteTransaction(transactionId: string): Promise<boolean>;
  ...
  export function uploadAccountBalanceHistory(
    accountId: string,
    csvContent: string
  ): Promise<void>;
  ...
  export function deleteAccount(accountId: string): Promise<DeleteAccountResponse>;

  export function requestAccountsRefresh(accountIds: string[]): Promise<boolean>;

  export function isAccountsRefreshComplete(
  ...
  export function requestAccountsRefreshAndDontWait(
    accountIds?: string[] | null
  ): Promise<boolean>;
